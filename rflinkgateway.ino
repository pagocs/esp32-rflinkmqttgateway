...
unsigned long   rflinkmasterheartbit = 0x7fffffff;
...
void rflinkinit( void )
{
    ...
    rflink.begin(57600, SERIAL_8N1, PIN_SERIAL_RX , PIN_SERIAL_TX ); // 16, 17); // pins 16 rx2, 17 tx2, 19200 bps, 8 bits no parity 1 stop bit
...
// FIXME
// Must refactor this function to using multithread and FreeRTOS queue
